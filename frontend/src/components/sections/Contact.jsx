...
import { ArrowUpRight, Mail, MapPin, Youtube, Instagram, Send } from "lucide-react";
      ...
      <div className="grid grid-cols-12 gap-6 md:gap-12">
        ...
        <div className="col-span-12 lg:col-span-5">
          ...
          <h2 className="font-serif-display text-5xl md:text-7xl lg:text-8xl tracking-tight leading-[0.95]">
            On
            <br />
            <span className="italic text-muted-foreground">tourne</span> ?
          </h2>
          <p className="mt-8 max-w-md text-sm md:text-base text-muted-foreground">
            Que tu sois créateur YouTube en pleine croissance ou marque qui veut une
            vidéo qui marque les esprits — raconte-moi ton projet, je reviens vers toi
            en moins de 24h.
          </p>
          ...
          <div className="mt-12 space-y-5">
            ...
            >
              ...
              <span className="link-underline">guildwen.marot@gmail.com</span>
            </a>
            <div className="flex items-center gap-4 text-muted-foreground">
              <MapPin size={18} strokeWidth={1.25} />
              <span>France — disponible en remote</span>
            </div>
          ...
          <div className="mt-16 border-t border-border pt-6 font-mono-label text-[10px] text-muted-foreground space-y-2">
            <div className="flex justify-between">
              <span>Status</span>
              <span className="text-foreground">● Slots ouverts — 2025</span>
            </div>
            <div className="flex justify-between">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
            <div className="md:col-span-1">
              <label htmlFor="name" className="font-mono-label text-[10px] text-muted-foreground">
                Nom *
              </label>
              <input
                id="name"
            ...
            <div className="md:col-span-2">
              <label htmlFor="channel" className="font-mono-label text-[10px] text-muted-foreground">
                Chaîne YouTube / Site (optionnel)
              </label>
              <input
                id="channel"
                name="channel"
            ...
            <div className="md:col-span-1">
              <label htmlFor="project_type" className="font-mono-label text-[10px] text-muted-foreground">
                Type de projet
              </label>
              <select
                id="project_type"
            ...
            <div className="md:col-span-1">
              <label htmlFor="budget" className="font-mono-label text-[10px] text-muted-foreground">
                Budget indicatif
              </label>
              <select
                id="budget"
            ...
            <div className="md:col-span-2">
              <label htmlFor="message" className="font-mono-label text-[10px] text-muted-foreground">
              ...
              <textarea
                ...
                placeholder="Le ton, la longueur, les références qui t'inspirent…"
            ...
            <div className="md:col-span-2 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pt-4">
              <p className="font-mono-label text-[10px] text-muted-foreground">
                * Champs obligatoires — Tu recevras une copie par email.
              </p>
              <button
                type="submit"
                disabled={loading}
