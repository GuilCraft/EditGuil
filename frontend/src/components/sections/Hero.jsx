  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10">
        {d.background_image && (
          <img src={resolveImage(d.background_image)} alt="" className="w-full h-full object-cover opacity-25" />
        )}
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 grid grid-cols-12 gap-6">
        <div className="col-span-12 flex items-center justify-between mb-12 reveal">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono-label text-[10px] text-muted-foreground">{d.scene_label}</span>
          </div>
          <span className="font-mono-label text-[10px] text-muted-foreground hidden md:inline">{d.take_label}</span>
        </div>
        ...
        <div className="col-span-12 lg:col-span-9 reveal reveal-delay-1">
          ...
          >
            {d.name_line1}
            <br />
            <span className="italic font-light text-muted-foreground">{d.name_line2}</span>
            {d.pseudo && (
        ...
        <div className="col-span-12 lg:col-span-3 lg:pl-6 lg:border-l lg:border-border lg:pt-4 reveal reveal-delay-2">
          <p className="font-mono-label text-[10px] text-muted-foreground mb-3">01 — Profil</p>
          <p className="text-sm md:text-base text-muted-foreground leading-relaxed">{d.profile_text}</p>
        </div>
        ...
        <div className="col-span-12 mt-16 lg:mt-24 flex flex-col md:flex-row items-start md:items-end justify-between gap-8 reveal reveal-delay-3">
          <div className="max-w-xl">
            <p className="font-mono-label text-[10px] text-muted-foreground mb-4">02 — Spécialités</p>
            <p className="font-serif-display text-2xl md:text-4xl leading-tight">{d.specialties_text}</p>
          </div>
